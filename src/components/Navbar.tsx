export default function Navbar() {
  return (
    <nav className="sticky top-0 z-50 bg-white border-b border-gray-200 px-4 sm:px-8 py-4 flex items-center justify-between">
      <span className="text-teal-600 text-lg sm:text-xl font-bold tracking-tight">
        CleanCo
      </span>
      ...
      <ul className="hidden md:flex gap-8 list-none">
       ...
       <a href="#quote"
        className="bg-teal-600 text-white text-xs sm:text-sm font-medium px-4 sm:px-5 py-2 rounded-lg hover:bg-teal-700 transition-colors"
      >
        Book Now
      </a>
    </nav>
